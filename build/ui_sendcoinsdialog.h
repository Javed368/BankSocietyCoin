...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/send-black"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 SOCI", 0));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 SOCI", 0));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 SOCI", 0));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 Society", 0));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 SOCI", 0));
#ifndef QT_NO_TOOLTIP
