...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 SOCI"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 SOCI"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 SOCI"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 SOCI"));
        ...
        treeWidget->setStyleSheet(QStringLiteral("background-color:transparent"));
