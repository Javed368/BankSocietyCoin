...
public:
    ...
    void setupUi(QWidget *MasternodeManager)
    {
        ...
        openMNConfigfileButton = new QPushButton(tab_2);
        openMNConfigfileButton->setObjectName(QStringLiteral("openMNConfigfileButton"));

        horizontalLayout_2->addWidget(openMNConfigfileButton);
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Society Node Count:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Society Network", 0));
        ...
        openMNConfigfileButton->setText(QApplication::translate("MasternodeManager", "&Masternode.conf", 0));
