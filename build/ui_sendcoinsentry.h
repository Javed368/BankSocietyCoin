...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/address-book-black"), QSize(), QIcon::Normal, QIcon::Off);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to (e.g. X8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
