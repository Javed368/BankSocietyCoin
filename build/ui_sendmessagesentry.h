...
public:
    ...
    void setupUi(QFrame *SendMessagesEntry)
    {
        ...
        SendMessagesEntry->setAutoFillBackground(false);
        SendMessagesEntry->setStyleSheet(QStringLiteral("background-color:rgb(255,255,255,.4);"));
    ...
    void retranslateUi(QFrame *SendMessagesEntry)
    {
        ...
        sendTo->setToolTip(QApplication::translate("SendMessagesEntry", "The address to send the payment to  (e.g. X8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
