...
public:
    ...
    QPushButton *openSocietyConfigfileButton;
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        openSocietyConfigfileButton = new QPushButton(tab_info);
        openSocietyConfigfileButton->setObjectName(QStringLiteral("openSocietyConfigfileButton"));
        openSocietyConfigfileButton->setAutoDefault(false);

        formLayout->setWidget(16, QFormLayout::LabelRole, openSocietyConfigfileButton);

        openMNConfigfileButton = new QPushButton(tab_info);
        openMNConfigfileButton->setObjectName(QStringLiteral("openMNConfigfileButton"));
        openMNConfigfileButton->setAutoDefault(false);

        formLayout->setWidget(17, QFormLayout::LabelRole, openMNConfigfileButton);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Society - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Bank Society Core", 0));
        ...
        labelDebugLogfile->setText(QApplication::translate("RPCConsole", "Troubleshooting", 0));
#ifndef QT_NO_TOOLTIP
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Society debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        openDebugLogfileButton->setText(QApplication::translate("RPCConsole", "&Debug.log", 0));
#ifndef QT_NO_TOOLTIP
        openSocietyConfigfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Society config file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        openSocietyConfigfileButton->setText(QApplication::translate("RPCConsole", "&Society.conf", 0));
#ifndef QT_NO_TOOLTIP
        openMNConfigfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Masternode config file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
        openMNConfigfileButton->setText(QApplication::translate("RPCConsole", "&Masternode.conf", 0));
        labelCLOptions->setText(QApplication::translate("RPCConsole", "Command-line options", 0));
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Society-Qt help message to get a list with possible Society command-line options.", 0));
#endif // QT_NO_TOOLTIP
