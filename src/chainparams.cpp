...
// Copyright (c) 2018 Bank Society Coin developers
...
/* RGP, changed pszTimestamp based on news of the dat to ensure that we actually created
        ...
        const char* pszTimestamp = "David Marcus resigns from Coinbase board - Business Times";
        CTransaction txNew;
        txNew.nTime = 1543694433; // GMT: Sat  1 Dec 20:01:04 GMT 2018
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
/* RGP, changed first 4 digits of scriptPubKey
		...
		txNew.vout[0].scriptPubKey = CScript() << ParseHex("1234e8e09a456a2ae88f9a2fdb9912");
        txNew.vout[0].nValue = 0;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1543694433; // Sat  1 Dec 20:01:04 GMT 2018
...
/* RGP, Changed to 0x
        ...
        /* RGP, refer to the following URL for a list of the PUBKEY_ADDRESS values
                ...
                Society Coin wants to set this to 63=> S */
...
/* RGP, Note zeroized some of these in preparation for Genesis. However, normally the
        ...
        genesis.nTime = 1543694378 ;// GMT: Sunday, 25 November 2018 10:44:27
        genesis.nBits  = 520159231;
        genesis.nNonce = 1006718;


        hashGenesisBlock = uint256("0xdcd1f68ebee1c3f2a0b9118a18c70a665ec9ef0aba2623a3b84cda1f9a213682");
        if (false && (genesis.GetHash() != hashGenesisBlock))
        {
            uint256 hashTarget = CBigNum().SetCompact(genesis.nBits).getuint256();
            while (genesis.GetHash() > hashTarget)
        ...
        /* RGP, refer to the following URL for a list of the PUBKEY_ADDRESS values
                https://en.bitcoin.it/wiki/List_of_address_prefixes
                Society Coin wants to set this to 125 => s */
