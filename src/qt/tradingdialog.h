...
private slots:
    ...
    QString BuySociety(QString OrderType, double Quantity, double Rate);
    QString SellSociety(QString OrderType, double Quantity, double Rate);
