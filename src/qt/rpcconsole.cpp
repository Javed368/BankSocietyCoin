...
/**
 * Split Society command line into a list of arguments. Aims to emulate \c bash and friends.
 *
    ...
    banTableContextMenu(0)
{
    ...
    ui->openSocietyConfigfileButton->setIcon(QIcon(":/icons/export"));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Society RPC console.") + "<br>" +
...
void RPCConsole::on_openSocietyConfigfileButton_clicked()
{
    GUIUtil::openSocietyConfigfile();
}
