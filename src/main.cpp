...
const string strMessageMagic = "Society Signed Message:\n";
...
/* ---------------------------------------------------------------------------
   -- RGP, Bank Society Coin Proof of Work Rewards                          --
   ---------------------------------------------------------------------------
   -- Premine Phase		: Block 1 to 100        Reward = 200,000    --
   -- PoW Phase Start		: Block 101 to 50000 	Reward = 5          --
   -- PoW Phase  		: Block 50001 to 250000	Reward = 25	    --
...
/* ---------------------------------------------------------------------------
   -- RGP, Bank Society Coin Proof of STake Rewards                         --
   ---------------------------------------------------------------------------
...
{
    RenameThread("Society-loadblk");


    CImportingNow imp;

    LogPrintf(" :ThreadImport Started, Society-loadblk \n");
    // -loadblock=
