...
CLS
echo -------------------------------------------------------------------
echo Society - Wallet Buddy 1.1 - Windows - (C) 2018 Profit Hunters Coin
echo -------------------------------------------------------------------
...
SET /P prompt= Clean Society AppData? Y/N 
...
cd %userprofile%\AppData\Roaming\Society\
del database-bkp
del txleveldb-bkp
del blk0001.dat-bkp
del db.log-bkp
...
SET /P prompt= Download society-qt.exe update (if available)? Y/N 
...
echo Downloading recent version of society-qt.exe...

curl.exe -O http://profithunterscoin.com/win/society-qt.exe
...
echo Loading society-qt.exe...

society-qt.exe -loadblock=bootstrap.dat
...
echo Loading society-qt.exe -repairwallet...

society-qt.exe -repairwallet
...
echo "Exiting Society Wallet Buddy..."
exit;
rem ------------------------------------------